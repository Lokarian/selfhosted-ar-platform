...
export interface IChatClient {
    testSignalR(): Observable<FileResponse>;
    testSignalR2(): Observable<FileResponse>;
...
export class ChatClient implements IChatClient {
    ...
    testSignalR(): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/Chat/TestSignalR";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processTestSignalR(response: HttpResponseBase): Observable<FileResponse> {
    ...
    testSignalR2(): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/Chat/TestSignalR2";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processTestSignalR2(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTestSignalR2(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<FileResponse>;
                }
            } else
    ...
    protected processTestSignalR2(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
