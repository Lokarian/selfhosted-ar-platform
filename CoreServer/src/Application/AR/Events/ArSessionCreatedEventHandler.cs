...
public class ArSessionCreatedEventHandler : INotificationHandler<ArSessionCreatedEvent>
{
    private readonly IUserProxy<IRpcArService> _userProxy;
    private readonly IMapper _mapper;
    private readonly IApplicationDbContext _context;

    public ArSessionCreatedEventHandler(IUserProxy<IRpcArService> userProxy, IMapper mapper,
